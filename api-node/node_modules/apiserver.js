...
ApiServer.prototype = {
	...
	if (args.answers === undefined) {
	    this._respond(request, response, { error: 'Bad Request', status: 403, msg: 'answers is required as encoded JSONArray'});
	    return;
	}
	if (args.lg === undefined) {
	    this._respond(request, response, { error: 'Bad Request', status: 403, msg: 'lg is required'});
	...
	var question_obj = {loc: [lg, lt], question: question, answers: answers};
