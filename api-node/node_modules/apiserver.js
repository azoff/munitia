...
ApiServer.prototype = {
	...
	var gps_point = {t: parseInt("" + (new Date().getTime()/1000)), loc: [parseFloat(args.lg, 10), parseFloat(args.lt)], user_id: args.user_id};
        this._add_optional_properties(args, gps_point, ['accuracy', 'altitude', 'altitudeAccuracy', 'heading', 'speed', 'name']);
	server._database.insert({ collection: 'gpslog', docs: [gps_point]}, function(error, results) {
    ...
    gps_points: function(request, response, args) {
        ...
        this._database.find({collection: 'gpslog', query: {name: {$in: names}} },
	    function(error, results) {
    ...
    create_question: function(request, response, args) {
        ...
        var answers  = {correct: args.correct, wrong0: args.wrong0};
        this._add_optional_properties(args, answers, ['wrong1', 'wrong2']);
        var question_obj = {loc: [parseFloat(args.lg, 10), parseFloat(args.lt, 10)], question: args.question, answers: answers};
